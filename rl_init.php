...
define('CREDITS', '<a href="http://www.wbz.my.id/" class="rl-link"><b>ZETHOR</b></a>&nbsp;<b class="rev-dev">ZLeech PlugMod (eqbal) rev. ' . $rev_num . '</b> <span class="rev-dev">' . $dev_name . '</span><br><small class="small-credits">Credits to Pramode &amp; Checkmate &amp; Kloon</small>');
